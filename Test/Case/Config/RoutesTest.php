 ...
 */
	public function dataProvider() {
		return array(
			array(
				'url' => '/faqs/faq_questions/view/1/content_key',
				'expected' => array(
					'plugin' => 'faqs', 'controller' => 'faq_questions', 'action' => 'view',
					'block_id' => '1', 'key' => 'content_key',
				)
			),
			array(
				'url' => '/faqs/faq_questions/edit/1/content_key',
				'expected' => array(
					'plugin' => 'faqs', 'controller' => 'faq_questions', 'action' => 'edit',
					'block_id' => '1', 'key' => 'content_key'
				)
			),
		);
